...
# Paleta de Cores
GERAL_PALETTE = ['#8338ec', '#ff006e', '#fb5607', '#3a86ff', '#ffbe0b']
...
LABELS_PT = {
    'year_month': 'Mês',
    'qtd_videos': 'Quantidade de Vídeos',
    'views': 'Visualizações',
    'engagement_rate': 'Taxa de Engajamento',
    'engagement_total': 'Engajamento Total',
    'upload_hour': 'Hora de Publicação',
    'platform': 'Plataforma',
    'category': 'Categoria',
    'duration_bin': 'Faixa de Duração',
    'publish_dayofweek': 'Dia da Semana',
    'country': 'País',
    'region': 'Região',
    'likes': 'Curtidas',
    'avg_views': 'Média de Visualizações',
    'avg_eng': 'Média de Engajamento',
    'iso_alpha': 'Código ISO',
    'count': 'Quantidade',
    'search_date': 'Data da Pesquisa',
    'interest_score': 'Interesse no Google',
    'keyword': 'Palavra-chave',
    'duration_sec': 'Duração (seg)',
    'is_weekend': 'Fim de Semana?'
}

# Conversão ISO-2 para ISO-3
ISO2_TO_ISO3 = {
